...
import com.allacsta.composesubmission.ui.navigation.NavigationItem
import com.allacsta.composesubmission.ui.navigation.Screen
import com.allacsta.composesubmission.ui.screen.cart.CartScreen
import com.allacsta.composesubmission.ui.screen.detail.DetailScreen
import com.allacsta.composesubmission.ui.screen.home.HomeScreen
import com.allacsta.composesubmission.ui.screen.profile.ProfileScreen
...
fun CoffeeShopApp(
    ...
    Scaffold(
        bottomBar = {
            if (currentRoute != Screen.DetailCoffee.route) {
...
private fun shareOrder(context: Context, summary: String) {
    val intent = Intent(Intent.ACTION_SEND).apply {
        type = "text/plain"
        putExtra(Intent.EXTRA_SUBJECT, context.getString(R.string.coffee_shop))
